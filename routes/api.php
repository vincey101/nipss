...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/user-position', [UserController::class, 'position']);
    ...
    Route::get('/position/dropdown', [PositionController::class, 'GetAllCategoriesForDropDown']);
    Route::middleware('hasToken:DOCUMENT_CATEGORY_MANAGE_DOCUMENT_CATEGORY')->group(function () {
        ...
        Route::get('/position/{id}/subcategories', [PositionController::class, 'subcategories']);
    });
    ...
    Route::group(['middleware' => ['hasToken:ALL_DOCUMENTS_CREATE_DOCUMENT, ASSIGNED_DOCUMENTS_CREATE_DOCUMENT, BULK_DOCUMENT_UPLOAD']], function () {
        Route::post('/document', [DocumentController::class, 'saveDocument']);
        Route:: get('/mytest', [DocumentController::class, 'automate_dept']);
    });
    ...
    Route::post('/media-libary', [DocumentController::class, 'mediaLibary']);
    Route::get('/get-media-libary', [DocumentController::class, 'getmediaLibary']);
    Route::delete('/delete-media-libary/{id}', [DocumentController::class, 'deletemediaLibary']);
