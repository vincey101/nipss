...
<div class="sm:mx-auto sm:w-full sm:max-w-md">
    @if (file_exists(public_path('nipss.png')))
    <div class="text-center">
        <img src="{{ asset('nipss.png') }}" alt="{{ config('app.name') }}" style="width: 50%;height: auto;border-radius: 10px;" class="mx-auto h-12 w-auto">
    </div>
    @endif
</div>
